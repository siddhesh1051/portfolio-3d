...
const ServiceCard = ({ index, title, icon }) => (
  <Tilt className="xs:w-[250px] w-full duration-100">
    <motion.div
    ...
    >
      ...
      >
        <img src={icon} alt="TILT-IM" className="w-16 h-16 object-contain" />
    ...
    <p className="mt-10 sm:text-[5rem] text-[2rem] text-center text-[#6d63bc]">
      {title.charAt(0)}
    </p>
  </Tilt>
);
